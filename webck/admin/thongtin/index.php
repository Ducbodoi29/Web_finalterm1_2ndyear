    ...
    <div class="templatemo-sidebar">
        ...
        <nav class="templatemo-left-nav">
            <ul>
                ...
                <li><a href="../Khachhang/index.php"><i class="fa fa-users"></i> THÔNG TIN KHÁCH HÀNG</a></li>
                <li><a href="../dondathang/index.php"><i class="fa fa-sliders"></i> ĐƠN ĐẶT HÀNG</a></li>
        ...
        <div class="templatemo-top-nav-container">
            <nav class="templatemo-top-nav">
                <ul class="text-right">
                    ...
                    <img src="" alt="Admin" class="img-thumbnail" style="width: 50px; height: 50px; border-radius: 25px;">
                </ul>
            </nav>
        </div>
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                    <form action="" method="post" class="form-inline text-center" style="margin-bottom: 20px;">
                        ...
                        <a href="addproduct.php" class="btn btn-success" style="margin-left: 10px">
